      ...
      >
        <View style={{ flexDirection: "row" }}>
          ...
          >
            ...
            <Text style={{ color: "white" }}>Location : Kampala, Uganda </Text>
        ...
        <View style={{ padding: 10 }}>
          <Text>
            ...
            estimated that the per capita generation of garbage is one kilogram
            per day. With a population of about 1.5 million, this works out to
            about 1500 tons. The council can only manage to dispose of 40% - 50%
            of this. About 80% of this garbage is organic matter which makes it
      ...
      >
        <View style={{ flexDirection: "row" }}>
          ...
          >
            ...
            <Text style={{ color: "white" }}>Contact :(+91) 9999-241-423</Text>
          </View>
        </View>
        <View style={{ padding: 10 }}>
          <Text>
